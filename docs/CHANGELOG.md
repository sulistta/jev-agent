...
- **LLM model patching rework** - Reworked provider compatibility request patches and refreshed the recommended model list.
...
- **GPT-5.4 support** - Added `gpt-5.4` to the recommended LLM list.
...
- **LLM Support** - Works with OpenAI-compatible APIs.
